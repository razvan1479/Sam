...
COMMANDS = [
    ...
    ("Leaderboard / Board-uri (admin)", [
        ("/leaderboard create", "nume rol [categorie] [canal]", "Creează un board (o singură dată). Canalul se face automat dacă nu îl dai."),
        ("/promoter_add", "membru [categorie]", "Adaugă un promoter: canal privat doar al lui + rol."),
        ("/tehnician_add", "membru [categorie]", "Adaugă un tehnician."),
        ("/developer_add", "membru [categorie]", "Adaugă un developer."),
        ("/gfx_add", "membru [categorie]", "Adaugă un GFX."),
        ("/manager_add", "membru [categorie]", "Adaugă un Discord Manager."),
        ("/leaderboard add", "board membru [categorie]", "Adaugă într-un board custom (autocomplete)."),
        ...
        ("/leaderboard delete / list", "", "Șterge un board / arată board-urile."),
    ]),
